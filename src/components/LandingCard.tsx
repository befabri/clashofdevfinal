...
export function LandingCard() {
    return (
        <article class="relative flex flex-col gap-8 rounded-[60px] bg-beige px-[86px] py-12 dark:bg-cod_black">
            ...
            <img src={baliseShieldSvg} class="absolute left-[-32px] top-[-32px] h-[80px] w-[103px]" />
            ...
            <div class="absolute right-[-99px] top-[57px] rotate-[-6.64deg]">
